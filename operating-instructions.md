...
Passband Tuning is disabled by default, go to the SETTINGS menu to [enable this function](#passband-tuning).
...
Tip: Save the original one-turn pot and re-use it for the [Passband Tuning](#clarifier) control.
